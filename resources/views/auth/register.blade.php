    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{role_id: 2}">
            ...
            <div class="mt-4" x-show="role_id == 4">
                <x-jet-label for="user_qualifications" value="{{ __('UserQualifications') }}" />
                <x-jet-input id="user_qualifications" class="block mt-1 w-full" type="text" :value="old('user_qualifications')" name="user_qualifications" />
            </div>
